...
class Block(nn.Module):
    def __init__(self,in_filters,out_filters,strides=1,atrous=None,grow_first=True,activate_first=True,inplace=True):
        ...
        if grow_first:      # 在block的第一个卷积层进行通道数的变化
            filters = out_filters
        else:
            filters = in_filters
...
class Xception(nn.Module):
    ...
    def __init__(self, downsample_factor):
        ...
        self.block2=Block(128,256,stride_list[0],inplace=False)     #inplace=False？
