...
if __name__ == '__main__':
    imgdir_path = '../data/train/aug_data3/img'
    labeldir_path = '../data/train/aug_data3/label'
    imgs = []
    ...
    torch.save(model.state_dict(), os.path.join(save_dir, 'deeplab_{}_final.pth'.format(model_num + 1)))
