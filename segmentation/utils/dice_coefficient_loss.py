...
def dice_coeff(x: torch.Tensor, target: torch.Tensor, ignore_index: int = 255, epsilon=1e-6):
...
def multiclass_dice_coeff(x: torch.Tensor, target: torch.Tensor, ignore_index: int = 255, epsilon=1e-6):
...
def dice_loss(x: torch.Tensor, target: torch.Tensor, multiclass: bool = False, ignore_index: int = 255):
