...
from segmentation.segnet.train import create_model
import cv2 as cv
...
if __name__ == '__main__':
    resdir_path = '../model_result/dataset1_trainset/segnet_model3'  # 存放模型预测结果
    save_flag = False
    model_weight_path = r'model/model3/segnet_3_best.pkl'
    net = create_model()
