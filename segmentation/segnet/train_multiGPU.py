...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        if (epoch+1) % 20 == 0:
            ...
            torch.save(model.module.state_dict(), os.path.join(save_dir, 'segnet_{}_{}.pkl'.format(model_num + 1,epoch)))
        ...
        if dice > max_dice and confmat.miou > max_miou:
            ...
            best_epoch = epoch
            print('save')
            torch.save(model.module.state_dict(),os.path.join(save_dir, 'segnet_{}_best.pkl'.format(model_num + 1)))
    ...
    torch.save(model.module.state_dict(), os.path.join(save_dir, 'segnet_{}_final.pkl'.format(model_num + 1)))

    plt.figure()
    plt.plot(loss_list)
    plt.savefig(r'../../loss_curve_150.jpg')
    # model1_t1.eval()
