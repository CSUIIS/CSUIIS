...
if __name__ == '__main__':
    resdir_path = '../model_result/dataset1_trainset/unet_model4'  # 存放模型预测结果
    save_flag = False
    model_weight_path = r'model/model4/unet_4_best.pkl'
    net = create_model(num_classes=2, base_c=64)
